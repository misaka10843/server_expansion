...
object LangProvider {
    ...
    class EnUs(output: PackOutput): LanguageProvider(output, MODID, "en_us") {
        override fun addTranslations() {
            ...
            add(LangKeys.CONFIG_DEBUG, "Debug")
            ...
            add(LangKeys.CONFIG_DEBUG_BLOCK_ENTITY, "Enable Block Entity Debugger")
            add(LangKeys.CONFIG_CLEANUP_RECOVERY, "Recovery")
            add(LangKeys.CONFIG_RECOVERY_EXPIRE_DAYS, "Recovery Item Expiration Days")
    ...
    class ZhCn(output: PackOutput): LanguageProvider(output, MODID, "zh_cn") {
        override fun addTranslations() {
            ...
            add(LangKeys.CONFIG_DEBUG_BLOCK_ENTITY, "启用方块实体调试器")
            add(LangKeys.CONFIG_CLEANUP_RECOVERY, "回收列表")
            add(LangKeys.CONFIG_RECOVERY_EXPIRE_DAYS, "回收物品过期天数")
